...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/finbridge/manage/fbFundInfo/">资金信息表列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="fbFundInfo" action="${ctx}/finbridge/manage/fbFundInfo/listFinish" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="fbFundInfo">
			<tr>
				...
				<shiro:hasPermission name="finbridge:manage:fbFundInfo:edit"><td>
					...
					<%--<a href="${ctx}/finbridge/manage/fbFundInfo/delete?id=${fbFundInfo.id}" onclick="return confirmx('确认要删除该资金信息表吗？', this.href)">删除</a>--%>
