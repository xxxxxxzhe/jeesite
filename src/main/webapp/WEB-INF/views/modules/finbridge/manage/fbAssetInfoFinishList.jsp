v<%@ page contentType="text/html;charset=UTF-8" %>
...
<body>
	...
	<form:form id="searchForm" modelAttribute="fbAssetInfo" action="${ctx}/finbridge/manage/fbAssetInfo/listFinish" method="post" class="breadcrumb form-search">
